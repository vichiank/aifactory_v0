...
export default function Home() {
  ...
  const handleInquirySubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Using Next.js API Route with Resend
          ...
          {isLoading ? (
            ...
            >
              ...
              <section id="home" className="relative pt-24 pb-24 px-8 lg:px-16 overflow-hidden">
                ...
                >
                  <h1 className="text-6xl lg:text-8xl font-display font-bold leading-[0.9] tracking-tighter mb-6 text-white">
                    AI Operations <br />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {projects.map((project, index) => (
                    <ProjectCard 
                      ...
                      index={index} 
                      onClick={() => handleViewChange(project.id)}
                    />
                  ))}
